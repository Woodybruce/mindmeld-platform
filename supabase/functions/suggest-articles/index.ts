...
const REAL_ARTICLES = [
  ...
  { title: "40 Questions to Build Intimacy", description: "Deepen your connection with thoughtful conversation starters", source: "Verywell Mind", category: "Intimacy", emoji: "💋", url: "https://www.verywellmind.com/questions-to-build-intimacy-in-relationships-1270942", imageHint: "couple intimacy" },
  ...
  // Date Ideas & Fun
  { title: "17 Fun Couple Activities to Enjoy Together", description: "Creative ways to enjoy each other's company at home or out", source: "Verywell Mind", category: "Date Ideas", emoji: "🕯️", url: "https://www.verywellmind.com/fun-things-couples-can-do-together-3129598", imageHint: "romantic date home" },
  ...
  { title: "The Three Parts of an Effective Apology", description: "Why how you say sorry matters as much as saying it", source: "Greater Good Magazine", category: "Conflict", emoji: "🕊️", url: "https://greatergood.berkeley.edu/article/item/the_three_parts_of_an_effective_apology", imageHint: "apology forgiveness" },
