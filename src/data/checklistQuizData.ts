    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "ch-family", text: "Family pressures / ADHD", type: "checkbox" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "sol-boundaries", text: "Boundaries for the girls — say NO", type: "checkbox" },
          ...
          { id: "sol-time", text: "Spend time together doing things without the girls", type: "checkbox" },
