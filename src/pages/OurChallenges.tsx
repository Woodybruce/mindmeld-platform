...
const defaultData: ChallengesData = {
  challenges: [
    { id: "ch1", text: "Communication Both" },
    { id: "ch2", text: "Judgment of Woody" },
    { id: "ch3", text: "Rejection physical and time together Woody" },
    { id: "ch4", text: "Doesn't feel safe due to reaction Helen" },
    { id: "ch5", text: "Thinks Woody going to leave Helen" },
    { id: "ch6", text: "ADHD Family Helen" },
    { id: "ch7", text: "Dismissive of problems Helen" },
    { id: "ch8", text: "Judgmental of problems Woody" },
    { id: "ch9", text: "Not Prioritising Woody" },
    { id: "ch10", text: "Intimacy" },
    { id: "ch11", text: "Phone use - Being present" },
  ],
  solutions: [
    { id: "s1", text: "Open ourselves to one another unconditionally", done: false },
    { id: "s2", text: "Boundaries for the girls. Say NO", done: false },
    { id: "s3", text: "Be supportive and grateful for each other", done: false },
    { id: "s4", text: "Able to ask and respond without judgment", done: false },
    { id: "s5", text: "Agree to be able to disagree", done: false },
    { id: "s6", text: "Talk with truth - Woody makes stuff up", done: false },
    { id: "s7", text: "Repair after any conflict with discussion", done: false },
    { id: "s8", text: "Prioritise our relationship over everything else", done: false },
    { id: "s9", text: "Phone down and be present", done: false },
    { id: "s10", text: "Try to maintain family support", done: false },
    { id: "s11", text: "Learn how to comfort Helen about her dad", done: false },
    { id: "s12", text: "Manage family workload / tasks", done: false },
    { id: "s13", text: "Embrace and kiss for 10 seconds everyday you leave or reunite", done: false },
    { id: "s14", text: "Say I love you", done: false },
    { id: "s15", text: "Spend time together doing things without the girls", done: false },
    { id: "s16", text: "Focus on our physical and sexual connection", done: false },
  ],
  solved: [
    { id: "sv1", text: "Made a One note app to use" },
    { id: "sv2", text: "Go to Hotel for night away" },
  ],
};
