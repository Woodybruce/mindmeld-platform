            ...
            <AnimatePresence>
              {editingShop && (
                ...
                >
                  ...
                  <div>
                    <label className="text-[10px] font-semibold text-muted-foreground uppercase">Amazon URL *</label>
                    <input
                    ...
                    />
                    <p className="text-[9px] text-muted-foreground/60 mt-0.5">Your affiliate tag is added automatically</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-[9px] text-muted-foreground/60 mt-0.5">Tip: right-click an Amazon product image → Copy image address</p>
                  </div>
