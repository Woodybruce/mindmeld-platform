    ...
    <div className="min-h-screen bg-background max-w-lg mx-auto relative">
      ...
      <Tabs defaultValue={defaultTab} className="px-4 pt-3 pb-24">
        ...
        <TabsContent value="games" className="mt-4 space-y-3">
          ...
          <GameCard title="Dare Duel" description="Draw dares and challenge your partner to beat you." emoji="⚔️" players="2 players · Anywhere" gradient="bg-gradient-to-br from-us-coral/20 to-us-gold/15" onClick={() => navigate("/dare-duel")} delay={0.16} />
          <GameCard title="Would You Rather" description="Impossible choices, hilarious debates." emoji="🤔" players="2 players · Anywhere" gradient="bg-gradient-to-br from-us-sage/15 to-us-cream/30" onClick={() => navigate("/would-you-rather")} delay={0.24} />
          <GameCard title="Photo Challenge" description="Complete fun photo tasks together as a team." emoji="📸" players="2 players · Outdoors" gradient="bg-gradient-to-br from-us-blush/20 to-us-coral/10" onClick={() => navigate("/photo-challenge")} delay={0.32} />
        </TabsContent>
