              ...
              >
                {!isRevealed ? (
                  ...
                  >
                    ...
                    <p className="text-[14px] font-bold uppercase tracking-widest text-foreground/50">{currentCard.category}</p>
            ...
            <div className="space-y-3">
              {drawn.map((card, i) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-[14px] font-bold uppercase tracking-wider text-foreground/50">{card.category}</p>
