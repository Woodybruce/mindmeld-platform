  ...
  return (
    ...
    >
      ...
      <div className="px-3 pb-2 flex gap-1.5 overflow-x-auto scrollbar-hide">
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={`text-[14px] font-semibold px-2.5 py-1 rounded-full whitespace-nowrap transition-colors ${
                  ...
                  <>
                    ...
                    <div className="relative w-full h-36 overflow-hidden">
                      ...
                      <div className="absolute bottom-1.5 left-1.5">
                        <span className="text-[13px] bg-background/80 backdrop-blur-sm text-foreground px-1.5 py-0.5 rounded-full font-medium">{p.category}</span>
                      </div>
                    </div>
                    {/* Product info */}
                    <div className="p-2.5">
                      <p className="text-xs font-semibold text-foreground leading-tight line-clamp-2">{p.name}</p>
                      <p className="text-[14px] text-muted-foreground mt-0.5">{p.brand}</p>
                      ...
                      {/* Amazon CTA */}
                      <div
                        className="mt-2 flex items-center justify-center gap-1 bg-[#FF9900] hover:bg-[#e88b00] text-white text-[14px] font-semibold py-1.5 rounded-lg transition-colors"
                      >
      ...
      <div className="px-4 pb-2.5 flex items-center gap-1">
        ...
        <p className="text-[13px] text-muted-foreground/50">Sponsored · Curated for couples</p>
      </div>
    </motion.div>
  );
};
