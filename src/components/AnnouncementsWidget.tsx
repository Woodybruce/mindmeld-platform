      ...
      {activities.length > 0 && (
        <>
          ...
          <div className="px-4 pt-3 pb-1 flex items-center gap-2">
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">What's New</span>
          </div>
          <div className="px-4 pb-4 pt-1 space-y-1 max-h-[160px] overflow-y-auto scrollbar-hide">
            {activities.map((a, i) => (
              <motion.button
                key={a.id}
                initial={{ opacity: 0, x: -8 }}
