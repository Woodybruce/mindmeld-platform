...
const PRODUCTS_TO_SEED: ProductDef[] = [
  ...
  { name: "Lip & Cheek Duo — Space NK", brand: "Space NK", description: "Buildable cream colour for a natural, flushed glow", priceGBP: 4200, category: "Gifts", shopProductName: "Lip & Cheek Duo" },
  { name: "Jo Malone Wood Sage & Sea Salt Cologne", brand: "Jo Malone", description: "Fresh, mineral unisex fragrance inspired by wind-swept coastlines", priceGBP: 11800, category: "Gifts", shopProductName: "Jo Malone Wood Sage & Sea Salt Cologne" },
  { name: "Personalised Star Map Print — Under Lucky Stars", brand: "Under Lucky Stars", description: "Custom map of the night sky from your special date and location", priceGBP: 6500, category: "Gifts", shopProductName: "Personalised Star Map Print" },
  ...
  { name: "Couples Conversation Card Game — The School of Life", brand: "The School of Life", description: "100 meaningful questions to deepen your connection", priceGBP: 1800, category: "Date Night", shopProductName: "Couples Conversation Card Game" },
  { name: "Cocktail Smoker Kit — Aged & Charred", brand: "Aged & Charred", description: "Smoke cocktails together with real wood chips — oak, cherry, apple and hickory", priceGBP: 5500, category: "Date Night", shopProductName: "Cocktail Smoker Kit" },
  { name: "Fondue Set for Two — Le Creuset", brand: "Le Creuset", description: "Cast iron mini fondue set in iconic Le Creuset colours", priceGBP: 8500, category: "Date Night", shopProductName: "Fondue Set for Two" },
  { name: "Diptyque Baies Candle", brand: "Diptyque", description: "The iconic blackcurrant and rose candle — a date night essential", priceGBP: 5600, category: "Date Night", shopProductName: "Diptyque Baies Candle" },

  { name: "Our Place Night & Day Glasses", brand: "Our Place", description: "Set of 4 hand-blown borosilicate glasses — perfect for wine nights in", priceGBP: 4500, category: "Home", shopProductName: "Our Place Night & Day Glasses" },
  { name: "Cashmere Bed Socks — The White Company", brand: "The White Company", description: "Sumptuously soft pure cashmere socks — the ultimate cosy-night-in luxury", priceGBP: 4500, category: "Home", shopProductName: "Cashmere Bed Socks" },
  { name: "Luxury Faux Fur Throw — The White Company", brand: "The White Company", description: "Ultra-soft faux fur throw — transform your sofa into a couples' sanctuary", priceGBP: 14900, category: "Home", shopProductName: "Luxury Faux Fur Throw" },
  { name: "Always Pan 2.0 — Our Place", brand: "Our Place", description: "The iconic 8-in-1 pan that replaces your frying pan, saucepan, steamer and more", priceGBP: 12500, category: "Home", shopProductName: "Always Pan 2.0" },
  { name: "Linen Duvet Cover Set — Piglet in Bed", brand: "Piglet in Bed", description: "100% European flax linen bedding — breathable, beautiful, gets softer with every wash", priceGBP: 19500, category: "Home", shopProductName: "Linen Duvet Cover Set" },
  { name: "Reed Diffuser Duo — Neom Organics", brand: "Neom Organics", description: "Set of 2 organic reed diffusers — one for the bedroom, one for the living room", priceGBP: 6800, category: "Home", shopProductName: "Reed Diffuser Duo" },
];
