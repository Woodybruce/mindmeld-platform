...
const LUXURY_INTIMACY_PRODUCTS = [
  ...
  { name: "Accessories & Hosiery", brand: "Agent Provocateur", price: "From \u00A325", description: "Luxurious stockings, suspenders & accessories", category: "Accessories", emoji: "\u{1F451}", affiliateTag: "ap-hosiery", productUrl: "https://www.agentprovocateur.com/gb_en/accessories" },
  { name: "New In Collection", brand: "Agent Provocateur", price: "From \u00A365", description: "Latest arrivals \u2014 lingerie, nightwear & gifts", category: "Lingerie", emoji: "\u{1F381}", affiliateTag: "ap-new-in", productUrl: "https://www.agentprovocateur.com/gb_en/new-in" },
  ...
  { name: "Daisy Lingerie Set", brand: "Sophie & Olivia", price: "\u00A379.00", description: "Delicate floral-inspired lingerie set with intricate lace detailing", category: "Lingerie", emoji: "\u{1F33C}", affiliateTag: "so-daisy", productUrl: "https://sophieolivia-lingerie.com/products/daisy-lingerie-set" },
  { name: "Gia Bodysuit", brand: "Sophie & Olivia", price: "\u00A389.00", description: "Sleek and sculpted bodysuit designed for confidence", category: "Lingerie", emoji: "\u{1F525}", affiliateTag: "so-gia", productUrl: "https://sophieolivia-lingerie.com/products/gia-bodysuit" },
  { name: "Jade 3-Piece Lingerie Set", brand: "Sophie & Olivia", price: "\u00A374.00", description: "Stunning three-piece set with bra, thong & suspender belt", category: "Lingerie", emoji: "\u{1F48E}", affiliateTag: "so-jade", productUrl: "https://sophieolivia-lingerie.com/products/jade-3-piece-lingerie-set" },
  { name: "Joyce 4-Piece Set", brand: "Sophie & Olivia", price: "\u00A389.00", description: "Luxury four-piece lingerie set for an unforgettable evening", category: "Lingerie", emoji: "\u2728", affiliateTag: "so-joyce", productUrl: "https://sophieolivia-lingerie.com/products/joyce-4-piece-set" },
  { name: "Selene Bodysuit", brand: "Sophie & Olivia", price: "\u00A374.00", description: "Elegant bodysuit with sheer mesh and lace panelling", category: "Lingerie", emoji: "\u{1F319}", affiliateTag: "so-selene", productUrl: "https://sophieolivia-lingerie.com/products/selene-bodysuit" },
  { name: "Best Sellers Collection", brand: "Sophie & Olivia", price: "From \u00A364", description: "Most-loved lingerie picks \u2014 bodysuits, sets & more", category: "Lingerie", emoji: "\u{1F31F}", affiliateTag: "so-bestsellers", productUrl: "https://sophieolivia-lingerie.com/collections/best-selling" },
];
