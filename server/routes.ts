...
const LUXURY_INTIMACY_PRODUCTS = [
  ...
  { name: "Lorna Plunge Underwired Bra", brand: "Agent Provocateur", price: "\u00A3108.00", description: "Silk and lace plunge bra with scalloped edges", longDescription: "The Lorna combines Italian silk-satin with intricate Calais lace for a modern plunge silhouette. Scalloped edges and a deep-V neckline make this piece both versatile and luxurious.", features: ["Italian silk-satin", "Calais lace overlay", "Scalloped edge detail", "Sizes 32B-36E"], category: "Lingerie", imageKeyword: "luxury bra silk lace editorial", productUrl: "https://www.agentprovocateur.com/gb_en/lingerie" },
  { name: "Keia Silk Kimono", brand: "Agent Provocateur", price: "\u00A3348.00", description: "Floor-length silk kimono with hand-painted floral print", longDescription: "Wrap yourself in luxury with this floor-length silk kimono featuring an exclusive hand-painted floral print. The perfect piece for lounging at home or as an unforgettable gift.", features: ["100% mulberry silk", "Hand-painted print", "Floor-length cut", "One size fits most"], category: "Nightwear", imageKeyword: "luxury silk kimono robe floral editorial", productUrl: "https://www.agentprovocateur.com/gb_en/nightwear" },
  { name: "Hosiery Gift Set", brand: "Agent Provocateur", price: "\u00A378.00", description: "Signature hold-ups and suspender set in gift packaging", longDescription: "The perfect introduction to Agent Provocateur. Includes silk hold-up stockings and a matching suspender belt in the iconic pink and black gift box.", features: ["Silk-blend stockings", "Matching suspender belt", "Signature gift packaging", "One size"], category: "Accessories", imageKeyword: "luxury hosiery stockings gift box elegant", productUrl: "https://www.agentprovocateur.com/gb_en/accessories" },
  { name: "G.Spot Vibrator", brand: "goop", price: "\u00A390.00", description: "Double-ended personal massager in medical-grade silicone", longDescription: "Designed in collaboration with intimacy experts, this beautifully sculpted vibrator features dual motors and 10 intensity settings. Medical-grade silicone with a whisper-quiet motor.", features: ["Medical-grade silicone", "10 intensity settings", "USB rechargeable", "Waterproof IPX7"], category: "Wellness", imageKeyword: "minimal luxury wellness product clean design", productUrl: "https://goop.com/wellness/sexual-health/" },
  { name: "Martinis & Massage Kit", brand: "goop", price: "\u00A378.00", description: "Date night kit with massage oil, candle & cocktail essentials", longDescription: "Everything for an unforgettable evening at home. Includes full-size body oil, hand-poured candle, two coupe glasses, and a recipe card for the perfect espresso martini.", features: ["Body oil + candle", "Two coupe glasses", "Cocktail recipe card", "Gift-ready packaging"], category: "Date Night", imageKeyword: "luxury date night kit candle cocktail", productUrl: "https://goop.com/shop/gifts/for-her/" },
